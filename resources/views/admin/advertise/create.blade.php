...
<div class="row">
	<div class="col-xs-12">
		<a href="/admin/advertise/" class="btn btn-primary">
			<span class="glyphicon glyphicon-list"></span>
			لیست آگهی ها</a>
        <div class="half-seperate"></div>
        @if(isset($advertise) )
		<form enctype="multipart/form-data" method="post" action="/admin/advertise/{{$advertise->id}}" id="form">
			{{ method_field('PUT') }}
		@else
		<form enctype="multipart/form-data" method="post" action="/admin/advertise" id="form">
		@endif
			{{ csrf_field() }}
            	...
            	<div class="table-responsive">
					<table class="table table-striped">
						...
						<tr>
							...
							<td><textarea type="text" rows="3" name="description" class="form-control">{{ $advertise->description or old('description') }}</textarea></td>
						</tr>
						</table>
						<advertise-field 
