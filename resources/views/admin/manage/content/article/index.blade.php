				...
				<tbody>
					...
					<tr>
						...
						<td class="width-20percent">
							@if($article->image)
								<img src="{{ $article->image->src100 }}" class="img-thumbnail image-table">
							@else
								تصویر ندارد
							@endif
						</td>
						...
						<td class="width-80px">
							<a href="/admin/manage/content/article/{{ $article->id }}">
								<span class="glyphicon glyphicon-eye-open"></span>
								مشاهده
							</a>
							<div class="one-third-seperate"></div>
							<a href="/admin/manage/content/article/{{ $article->id }}/edit">
