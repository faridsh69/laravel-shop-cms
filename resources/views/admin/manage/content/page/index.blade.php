				...
				<tbody>
					...
					<tr>
						...
						<td class="width-20percent">
							@if($page->image)
								<img src="{{ $page->image->src }}" class="img-thumbnail image-table">
							@else
								تصویر ندارد
							@endif
						</td>
						...
						<td class="width-80px">
							<a href="/admin/manage/content/page/{{ $page->id }}">
								<span class="glyphicon glyphicon-eye-open"></span>
								مشاهده
							</a>
							<div class="one-third-seperate"></div>
							<a href="/admin/manage/content/page/{{ $page->id }}/edit">
