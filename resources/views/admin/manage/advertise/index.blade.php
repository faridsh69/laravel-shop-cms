...
<div class="row">
	<div class="col-xs-12">
		@foreach (['danger', 'warning', 'success', 'info'] as $msg)
            ...
            @endif
        @endforeach
        <a href="{{ route('advertise.create') }}" class="btn btn-success">
				...
				<form class="form-inline" method="GET">
			  		...
			  		<div class="form-group">
				    	...
				    	<select class="form-control" name="status" id="status">
							<option value="">همه</option>
							@foreach(\App\Models\Advertise::$STATUS as $key => $value)
								<option value="{{ $key }}"> 
									{{ $value }}
								</option>
							@endforeach
			...
			<div class="reponsive-table">
				...
				<tbody>
					...
					<tr>
						...
						<td class="width-80px">
							<a href="/admin/manage/advertise/{{ $advertise->id }}">
								<span class="glyphicon glyphicon-eye-open"></span>
								مشاهده
							</a>
							<div class="one-third-seperate"></div>
							<a href="/admin/manage/advertise/{{ $advertise->id }}/edit">
