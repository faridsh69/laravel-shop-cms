...
<div class="row">
	<div class="col-xs-12">
        ...
        <div class="half-seperate"></div>
		 @if(isset($forum) )
		<form enctype="multipart/form-data" method="post" action="/admin/manage/forum/{{$forum->id}}" id="form">
			{{ method_field('PUT') }}
		@else
		<form enctype="multipart/form-data" method="post" action="/admin/manage/forum" id="form">
		@endif
			{{ csrf_field() }}
